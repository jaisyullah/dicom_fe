  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_credential_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_credential_mob_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_credential_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_credential_mob_validate_id(var_id, var_script_case_init, do_ajax_form_credential_mob_validate_id_cb);
  } // do_ajax_form_credential_mob_validate_id

  function do_ajax_form_credential_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_credential_mob_validate_id_cb

  // ---------- Validate client_id
  function do_ajax_form_credential_mob_validate_client_id()
  {
    var nomeCampo_client_id = "client_id";
    var var_client_id = scAjaxGetFieldText(nomeCampo_client_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_credential_mob_validate_client_id(var_client_id, var_script_case_init, do_ajax_form_credential_mob_validate_client_id_cb);
  } // do_ajax_form_credential_mob_validate_client_id

  function do_ajax_form_credential_mob_validate_client_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_credential_mob_validate_client_id_cb

  // ---------- Validate client_secret
  function do_ajax_form_credential_mob_validate_client_secret()
  {
    var nomeCampo_client_secret = "client_secret";
    var var_client_secret = scAjaxGetFieldText(nomeCampo_client_secret);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_credential_mob_validate_client_secret(var_client_secret, var_script_case_init, do_ajax_form_credential_mob_validate_client_secret_cb);
  } // do_ajax_form_credential_mob_validate_client_secret

  function do_ajax_form_credential_mob_validate_client_secret_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_credential_mob_validate_client_secret_cb

  // ---------- Validate organization_id
  function do_ajax_form_credential_mob_validate_organization_id()
  {
    var nomeCampo_organization_id = "organization_id";
    var var_organization_id = scAjaxGetFieldText(nomeCampo_organization_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_credential_mob_validate_organization_id(var_organization_id, var_script_case_init, do_ajax_form_credential_mob_validate_organization_id_cb);
  } // do_ajax_form_credential_mob_validate_organization_id

  function do_ajax_form_credential_mob_validate_organization_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "organization_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_credential_mob_validate_organization_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_credential_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_credential_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_organization_id = scAjaxGetFieldText("organization_id");
    ...
    scAjaxProcOn();
    x_ajax_form_credential_mob_submit_form(var_id, var_client_id, var_client_secret, var_organization_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_credential_mob_submit_form_cb);
  } // do_ajax_form_credential_mob_submit_form

  function do_ajax_form_credential_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_credential_mob_submit_form_cb_after_alert);
  } // do_ajax_form_credential_mob_submit_form_cb
  function do_ajax_form_credential_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_credential_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_credential_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_credential_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_credential_mob_navigate_form();
    }
  }

  function perform_ajax_form_credential_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_credential_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_credential_mob_navigate_form_cb);
  } // do_ajax_form_credential_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_credential_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_credential_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_credential_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_credential_mob_navigate_form_cb
  function do_ajax_form_credential_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_credential_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_credential_mob_navigate_form_cb_after_alert

  function sc_hide_form_credential_mob_form()
  {
  ...
  ajax_field_list[2] = "client_secret";
  ajax_field_list[3] = "organization_id";
  ...
  var ajax_error_list = {
    ...
    "client_secret": {"label": "Client Secret", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "organization_id": {"label": "Organization ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_id = {
    ...
    "organization_id": new Array("hidden_field_label_organization_id", "hidden_field_data_organization_id")
  };
