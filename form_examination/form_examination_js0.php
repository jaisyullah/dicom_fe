...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_examination']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_examination']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_examination"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_sc_btn_0()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Apakah anda yakin mengirim Order ini ke MWL ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_0_ok, sc_btn_sc_btn_0_cancel)
}
...
function sc_btn_sc_btn_1()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Apakah anda yakin mengirim Order ini ke SATUSEHAT ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_1_ok, sc_btn_sc_btn_1_cancel)
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_examination']['where_detal']))
  {
?>  
