  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_examination_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_examination_mob_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_examination_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_mob_validate_id(var_id, var_script_case_init, do_ajax_form_examination_mob_validate_id_cb);
  } // do_ajax_form_examination_mob_validate_id

  function do_ajax_form_examination_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_mob_validate_id_cb

  // ---------- Validate patient_rm
  function do_ajax_form_examination_mob_validate_patient_rm()
  {
    var nomeCampo_patient_rm = "patient_rm";
    var var_patient_rm = scAjaxGetFieldSelect(nomeCampo_patient_rm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_mob_validate_patient_rm(var_patient_rm, var_script_case_init, do_ajax_form_examination_mob_validate_patient_rm_cb);
  } // do_ajax_form_examination_mob_validate_patient_rm

  function do_ajax_form_examination_mob_validate_patient_rm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patient_rm";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_mob_validate_patient_rm_cb

  // ---------- Validate jenis_pemeriksaan
  function do_ajax_form_examination_mob_validate_jenis_pemeriksaan()
  {
    var nomeCampo_jenis_pemeriksaan = "jenis_pemeriksaan";
    var var_jenis_pemeriksaan = scAjaxGetFieldSelect(nomeCampo_jenis_pemeriksaan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_mob_validate_jenis_pemeriksaan(var_jenis_pemeriksaan, var_script_case_init, do_ajax_form_examination_mob_validate_jenis_pemeriksaan_cb);
  } // do_ajax_form_examination_mob_validate_jenis_pemeriksaan

  function do_ajax_form_examination_mob_validate_jenis_pemeriksaan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jenis_pemeriksaan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_mob_validate_jenis_pemeriksaan_cb

  // ---------- Validate tgl_pemeriksaan
  function do_ajax_form_examination_mob_validate_tgl_pemeriksaan()
  {
    var nomeCampo_tgl_pemeriksaan = "tgl_pemeriksaan";
    var var_tgl_pemeriksaan = scAjaxGetFieldText(nomeCampo_tgl_pemeriksaan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_mob_validate_tgl_pemeriksaan(var_tgl_pemeriksaan, var_script_case_init, do_ajax_form_examination_mob_validate_tgl_pemeriksaan_cb);
  } // do_ajax_form_examination_mob_validate_tgl_pemeriksaan

  function do_ajax_form_examination_mob_validate_tgl_pemeriksaan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tgl_pemeriksaan";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_mob_validate_tgl_pemeriksaan_cb

  // ---------- Validate dpjp
  function do_ajax_form_examination_mob_validate_dpjp()
  {
    var nomeCampo_dpjp = "dpjp";
    var var_dpjp = scAjaxGetFieldSelect(nomeCampo_dpjp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_mob_validate_dpjp(var_dpjp, var_script_case_init, do_ajax_form_examination_mob_validate_dpjp_cb);
  } // do_ajax_form_examination_mob_validate_dpjp

  function do_ajax_form_examination_mob_validate_dpjp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dpjp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_mob_validate_dpjp_cb

  // ---------- Validate accno
  function do_ajax_form_examination_mob_validate_accno()
  {
    var nomeCampo_accno = "accno";
    var var_accno = scAjaxGetFieldText(nomeCampo_accno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_mob_validate_accno(var_accno, var_script_case_init, do_ajax_form_examination_mob_validate_accno_cb);
  } // do_ajax_form_examination_mob_validate_accno

  function do_ajax_form_examination_mob_validate_accno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "accno";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_mob_validate_accno_cb

  // ---------- Validate identifiersr
  function do_ajax_form_examination_mob_validate_identifiersr()
  {
    var nomeCampo_identifiersr = "identifiersr";
    var var_identifiersr = scAjaxGetFieldText(nomeCampo_identifiersr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_mob_validate_identifiersr(var_identifiersr, var_script_case_init, do_ajax_form_examination_mob_validate_identifiersr_cb);
  } // do_ajax_form_examination_mob_validate_identifiersr

  function do_ajax_form_examination_mob_validate_identifiersr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "identifiersr";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_mob_validate_identifiersr_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_examination_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_examination_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_patient_rm = scAjaxGetFieldSelect("patient_rm");
    var var_jenis_pemeriksaan = scAjaxGetFieldSelect("jenis_pemeriksaan");
    var var_tgl_pemeriksaan = scAjaxGetFieldText("tgl_pemeriksaan");
    var var_dpjp = scAjaxGetFieldSelect("dpjp");
    var var_accno = scAjaxGetFieldText("accno");
    var var_identifiersr = scAjaxGetFieldText("identifiersr");
    ...
    scAjaxProcOn();
    x_ajax_form_examination_mob_submit_form(var_id, var_patient_rm, var_jenis_pemeriksaan, var_tgl_pemeriksaan, var_dpjp, var_accno, var_identifiersr, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_examination_mob_submit_form_cb);
  } // do_ajax_form_examination_mob_submit_form

  function do_ajax_form_examination_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_examination_mob_submit_form_cb_after_alert);
  } // do_ajax_form_examination_mob_submit_form_cb
  function do_ajax_form_examination_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_examination_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_examination_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_examination_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_examination_mob_navigate_form();
    }
  }

  function perform_ajax_form_examination_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_examination_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_examination_mob_navigate_form_cb);
  } // do_ajax_form_examination_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_examination_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_examination_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_examination_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_examination_mob_navigate_form_cb
  function do_ajax_form_examination_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_examination_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_examination_mob_navigate_form_cb_after_alert

  function sc_hide_form_examination_mob_form()
  {
  ...
  ajax_field_list[1] = "patient_rm";
  ajax_field_list[2] = "jenis_pemeriksaan";
  ajax_field_list[3] = "tgl_pemeriksaan";
  ajax_field_list[4] = "dpjp";
  ajax_field_list[5] = "accno";
  ajax_field_list[6] = "identifiersr";
  ...
  var ajax_error_list = {
    ...
    "patient_rm": {"label": "RM Pasien", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "jenis_pemeriksaan": {"label": "Jenis Pemeriksaan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "tgl_pemeriksaan": {"label": "Tgl Pemeriksaan", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "dpjp": {"label": "DPJP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "accno": {"label": "Accession Number", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "identifiersr": {"label": "Identifier ServiceRequest", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_mult = {
    "id": new Array(),
    "patient_rm": new Array(),
    "jenis_pemeriksaan": new Array(),
    "tgl_pemeriksaan": new Array(),
    "dpjp": new Array(),
    "accno": new Array(),
    "identifiersr": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["patient_rm"][1] = "patient_rm";
  ajax_field_mult["jenis_pemeriksaan"][1] = "jenis_pemeriksaan";
  ajax_field_mult["tgl_pemeriksaan"][1] = "tgl_pemeriksaan";
  ajax_field_mult["dpjp"][1] = "dpjp";
  ajax_field_mult["accno"][1] = "accno";
  ajax_field_mult["identifiersr"][1] = "identifiersr";

  var ajax_field_id = {
    "patient_rm": new Array("hidden_field_label_patient_rm", "hidden_field_data_patient_rm"),
    "jenis_pemeriksaan": new Array("hidden_field_label_jenis_pemeriksaan", "hidden_field_data_jenis_pemeriksaan"),
    "tgl_pemeriksaan": new Array("hidden_field_label_tgl_pemeriksaan", "hidden_field_data_tgl_pemeriksaan"),
    "dpjp": new Array("hidden_field_label_dpjp", "hidden_field_data_dpjp"),
    "accno": new Array("hidden_field_label_accno", "hidden_field_data_accno"),
    "identifiersr": new Array("hidden_field_label_identifiersr", "hidden_field_data_identifiersr")
  };

  var ajax_read_only = {
    "id": "on",
    "patient_rm": "off",
    "jenis_pemeriksaan": "off",
    "tgl_pemeriksaan": "off",
    "dpjp": "off",
    "accno": "off",
    "identifiersr": "off"
