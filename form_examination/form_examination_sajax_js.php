  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_examination" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_examination_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_validate_id(var_id, var_script_case_init, do_ajax_form_examination_validate_id_cb);
  } // do_ajax_form_examination_validate_id

  function do_ajax_form_examination_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_validate_id_cb

  // ---------- Validate patient_rm
  function do_ajax_form_examination_validate_patient_rm()
  {
    var nomeCampo_patient_rm = "patient_rm";
    var var_patient_rm = scAjaxGetFieldSelect(nomeCampo_patient_rm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_validate_patient_rm(var_patient_rm, var_script_case_init, do_ajax_form_examination_validate_patient_rm_cb);
  } // do_ajax_form_examination_validate_patient_rm

  function do_ajax_form_examination_validate_patient_rm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_validate_patient_rm_cb

  // ---------- Validate jenis_pemeriksaan
  function do_ajax_form_examination_validate_jenis_pemeriksaan()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_validate_jenis_pemeriksaan(var_jenis_pemeriksaan, var_script_case_init, do_ajax_form_examination_validate_jenis_pemeriksaan_cb);
  } // do_ajax_form_examination_validate_jenis_pemeriksaan

  function do_ajax_form_examination_validate_jenis_pemeriksaan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_validate_jenis_pemeriksaan_cb

  // ---------- Validate tgl_pemeriksaan
  function do_ajax_form_examination_validate_tgl_pemeriksaan()
  {
    var nomeCampo_tgl_pemeriksaan = "tgl_pemeriksaan";
    var var_tgl_pemeriksaan = scAjaxGetFieldText(nomeCampo_tgl_pemeriksaan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_validate_tgl_pemeriksaan(var_tgl_pemeriksaan, var_script_case_init, do_ajax_form_examination_validate_tgl_pemeriksaan_cb);
  } // do_ajax_form_examination_validate_tgl_pemeriksaan

  function do_ajax_form_examination_validate_tgl_pemeriksaan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_validate_tgl_pemeriksaan_cb

  // ---------- Validate dpjp
  function do_ajax_form_examination_validate_dpjp()
  {
    var nomeCampo_dpjp = "dpjp";
    var var_dpjp = scAjaxGetFieldSelect(nomeCampo_dpjp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_validate_dpjp(var_dpjp, var_script_case_init, do_ajax_form_examination_validate_dpjp_cb);
  } // do_ajax_form_examination_validate_dpjp

  function do_ajax_form_examination_validate_dpjp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dpjp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_validate_dpjp_cb

  // ---------- Validate accno
  function do_ajax_form_examination_validate_accno()
  {
    var nomeCampo_accno = "accno";
    var var_accno = scAjaxGetFieldText(nomeCampo_accno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_validate_accno(var_accno, var_script_case_init, do_ajax_form_examination_validate_accno_cb);
  } // do_ajax_form_examination_validate_accno

  function do_ajax_form_examination_validate_accno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "accno";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_validate_accno_cb

  // ---------- Validate identifiersr
  function do_ajax_form_examination_validate_identifiersr()
  {
    var nomeCampo_identifiersr = "identifiersr";
    var var_identifiersr = scAjaxGetFieldText(nomeCampo_identifiersr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_examination_validate_identifiersr(var_identifiersr, var_script_case_init, do_ajax_form_examination_validate_identifiersr_cb);
  } // do_ajax_form_examination_validate_identifiersr

  function do_ajax_form_examination_validate_identifiersr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_examination_validate_identifiersr_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_examination_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_examination_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_examination_submit_form(var_id, var_patient_rm, var_jenis_pemeriksaan, var_tgl_pemeriksaan, var_dpjp, var_accno, var_identifiersr, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_examination_submit_form_cb);
  } // do_ajax_form_examination_submit_form

  function do_ajax_form_examination_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_examination_submit_form_cb_after_alert);
  } // do_ajax_form_examination_submit_form_cb
  function do_ajax_form_examination_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_examination_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_examination_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_examination_navigate_form, function() {});
    } else {
      perform_ajax_form_examination_navigate_form();
    }
  }

  function perform_ajax_form_examination_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_examination_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_examination_navigate_form_cb);
  } // do_ajax_form_examination_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_examination']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_examination_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_examination_navigate_form_cb_after_alert);
  } // do_ajax_form_examination_navigate_form_cb
  function do_ajax_form_examination_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_examination_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_examination_navigate_form_cb_after_alert

  function sc_hide_form_examination_form()
  {
