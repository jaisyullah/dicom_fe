  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mwl_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate mwl_ip
  function do_ajax_form_mwl_mob_validate_mwl_ip()
  {
    var nomeCampo_mwl_ip = "mwl_ip";
    var var_mwl_ip = scAjaxGetFieldText(nomeCampo_mwl_ip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mwl_mob_validate_mwl_ip(var_mwl_ip, var_script_case_init, do_ajax_form_mwl_mob_validate_mwl_ip_cb);
  } // do_ajax_form_mwl_mob_validate_mwl_ip

  function do_ajax_form_mwl_mob_validate_mwl_ip_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mwl_mob_validate_mwl_ip_cb

  // ---------- Validate mwl_port
  function do_ajax_form_mwl_mob_validate_mwl_port()
  {
    var nomeCampo_mwl_port = "mwl_port";
    var var_mwl_port = scAjaxGetFieldText(nomeCampo_mwl_port);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mwl_mob_validate_mwl_port(var_mwl_port, var_script_case_init, do_ajax_form_mwl_mob_validate_mwl_port_cb);
  } // do_ajax_form_mwl_mob_validate_mwl_port

  function do_ajax_form_mwl_mob_validate_mwl_port_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mwl_port";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mwl_mob_validate_mwl_port_cb

  // ---------- Validate id
  function do_ajax_form_mwl_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mwl_mob_validate_id(var_id, var_script_case_init, do_ajax_form_mwl_mob_validate_id_cb);
  } // do_ajax_form_mwl_mob_validate_id

  function do_ajax_form_mwl_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mwl_mob_validate_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mwl_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mwl_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_mwl_ip = scAjaxGetFieldText("mwl_ip");
    var var_mwl_port = scAjaxGetFieldText("mwl_port");
    ...
    scAjaxProcOn();
    x_ajax_form_mwl_mob_submit_form(var_mwl_ip, var_mwl_port, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mwl_mob_submit_form_cb);
  } // do_ajax_form_mwl_mob_submit_form

  function do_ajax_form_mwl_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mwl_mob_submit_form_cb_after_alert);
  } // do_ajax_form_mwl_mob_submit_form_cb
  function do_ajax_form_mwl_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mwl_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_mwl_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_mwl_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_mwl_mob_navigate_form();
    }
  }

  function perform_ajax_form_mwl_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_mwl_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mwl_mob_navigate_form_cb);
  } // do_ajax_form_mwl_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mwl_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mwl_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mwl_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_mwl_mob_navigate_form_cb
  function do_ajax_form_mwl_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_mwl_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mwl_mob_navigate_form_cb_after_alert

  function sc_hide_form_mwl_mob_form()
  {
  ...
  ajax_field_list[0] = "mwl_ip";
  ajax_field_list[1] = "mwl_port";
  ...
  var ajax_error_list = {
    "mwl_ip": {"label": "MWL IP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "mwl_port": {"label": "MWL Port", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  ajax_field_mult["mwl_ip"][1] = "mwl_ip";
  ajax_field_mult["mwl_port"][1] = "mwl_port";
  ajax_field_mult["id"][1] = "id";

  var ajax_field_id = {
    "mwl_ip": new Array("hidden_field_label_mwl_ip", "hidden_field_data_mwl_ip"),
