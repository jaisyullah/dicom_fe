  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_patient_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_patient_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_mob_validate_id(var_id, var_script_case_init, do_ajax_form_patient_mob_validate_id_cb);
  } // do_ajax_form_patient_mob_validate_id

  function do_ajax_form_patient_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_mob_validate_id_cb

  // ---------- Validate patient_nik
  function do_ajax_form_patient_mob_validate_patient_nik()
  {
    var nomeCampo_patient_nik = "patient_nik";
    var var_patient_nik = scAjaxGetFieldText(nomeCampo_patient_nik);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_mob_validate_patient_nik(var_patient_nik, var_script_case_init, do_ajax_form_patient_mob_validate_patient_nik_cb);
  } // do_ajax_form_patient_mob_validate_patient_nik

  function do_ajax_form_patient_mob_validate_patient_nik_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patient_nik";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_mob_validate_patient_nik_cb

  // ---------- Validate name
  function do_ajax_form_patient_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_mob_validate_name(var_name, var_script_case_init, do_ajax_form_patient_mob_validate_name_cb);
  } // do_ajax_form_patient_mob_validate_name

  function do_ajax_form_patient_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_mob_validate_name_cb

  // ---------- Validate no_ihs
  function do_ajax_form_patient_mob_validate_no_ihs()
  {
    var nomeCampo_no_ihs = "no_ihs";
    var var_no_ihs = scAjaxGetFieldText(nomeCampo_no_ihs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_mob_validate_no_ihs(var_no_ihs, var_script_case_init, do_ajax_form_patient_mob_validate_no_ihs_cb);
  } // do_ajax_form_patient_mob_validate_no_ihs

  function do_ajax_form_patient_mob_validate_no_ihs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "no_ihs";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_mob_validate_no_ihs_cb

  // ---------- Validate patient_rm
  function do_ajax_form_patient_mob_validate_patient_rm()
  {
    var nomeCampo_patient_rm = "patient_rm";
    var var_patient_rm = scAjaxGetFieldText(nomeCampo_patient_rm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_mob_validate_patient_rm(var_patient_rm, var_script_case_init, do_ajax_form_patient_mob_validate_patient_rm_cb);
  } // do_ajax_form_patient_mob_validate_patient_rm

  function do_ajax_form_patient_mob_validate_patient_rm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_mob_validate_patient_rm_cb

  // ---------- Validate response
  function do_ajax_form_patient_mob_validate_response()
  {
    var nomeCampo_response = "response";
    var var_response = scAjaxGetFieldText(nomeCampo_response);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_mob_validate_response(var_response, var_script_case_init, do_ajax_form_patient_mob_validate_response_cb);
  } // do_ajax_form_patient_mob_validate_response

  function do_ajax_form_patient_mob_validate_response_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "response";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_mob_validate_response_cb

  // ---------- Validate birthdate
  function do_ajax_form_patient_mob_validate_birthdate()
  {
    var nomeCampo_birthdate = "birthdate";
    var var_birthdate = scAjaxGetFieldText(nomeCampo_birthdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_mob_validate_birthdate(var_birthdate, var_script_case_init, do_ajax_form_patient_mob_validate_birthdate_cb);
  } // do_ajax_form_patient_mob_validate_birthdate

  function do_ajax_form_patient_mob_validate_birthdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_mob_validate_birthdate_cb

  // ---------- Validate gender
  function do_ajax_form_patient_mob_validate_gender()
  {
    var nomeCampo_gender = "gender";
    var var_gender = scAjaxGetFieldText(nomeCampo_gender);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_mob_validate_gender(var_gender, var_script_case_init, do_ajax_form_patient_mob_validate_gender_cb);
  } // do_ajax_form_patient_mob_validate_gender

  function do_ajax_form_patient_mob_validate_gender_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gender";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_mob_validate_gender_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_patient_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_patient_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_patient_nik = scAjaxGetFieldText("patient_nik");
    var var_name = scAjaxGetFieldText("name");
    var var_no_ihs = scAjaxGetFieldText("no_ihs");
    var var_patient_rm = scAjaxGetFieldText("patient_rm");
    var var_response = scAjaxGetFieldText("response");
    ...
    scAjaxProcOn();
    x_ajax_form_patient_mob_submit_form(var_id, var_patient_nik, var_name, var_no_ihs, var_patient_rm, var_response, var_birthdate, var_gender, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_patient_mob_submit_form_cb);
  } // do_ajax_form_patient_mob_submit_form

  function do_ajax_form_patient_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_patient_mob_submit_form_cb_after_alert);
  } // do_ajax_form_patient_mob_submit_form_cb
  function do_ajax_form_patient_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_patient_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_patient_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_patient_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_patient_mob_navigate_form();
    }
  }

  function perform_ajax_form_patient_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_patient_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_patient_mob_navigate_form_cb);
  } // do_ajax_form_patient_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_patient_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_patient_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_patient_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_patient_mob_navigate_form_cb
  function do_ajax_form_patient_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_patient_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_patient_mob_navigate_form_cb_after_alert

  function sc_hide_form_patient_mob_form()
  {
  ...
  ajax_field_list[1] = "patient_nik";
  ajax_field_list[2] = "name";
  ajax_field_list[3] = "no_ihs";
  ajax_field_list[4] = "patient_rm";
  ajax_field_list[5] = "response";
  ajax_field_list[6] = "birthdate";
  ajax_field_list[7] = "gender";
  ...
  var ajax_error_list = {
    ...
    "patient_nik": {"label": "Patient Nik", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "name": {"label": "Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "no_ihs": {"label": "No Ihs", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "patient_rm": {"label": "Patient Rm", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "response": {"label": "Response", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    ...
    "gender": {"label": "Gender", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["patient_nik"][1] = "patient_nik";
  ajax_field_mult["name"][1] = "name";
  ajax_field_mult["no_ihs"][1] = "no_ihs";
  ajax_field_mult["patient_rm"][1] = "patient_rm";
  ajax_field_mult["response"][1] = "response";
  ajax_field_mult["birthdate"][1] = "birthdate";
  ajax_field_mult["gender"][1] = "gender";

  var ajax_field_id = {
    "patient_nik": new Array("hidden_field_label_patient_nik", "hidden_field_data_patient_nik"),
    "name": new Array("hidden_field_label_name", "hidden_field_data_name"),
    "no_ihs": new Array("hidden_field_label_no_ihs", "hidden_field_data_no_ihs"),
    "patient_rm": new Array("hidden_field_label_patient_rm", "hidden_field_data_patient_rm"),
    "response": new Array("hidden_field_label_response", "hidden_field_data_response"),
