  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_patient" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_patient_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_validate_id(var_id, var_script_case_init, do_ajax_form_patient_validate_id_cb);
  } // do_ajax_form_patient_validate_id

  function do_ajax_form_patient_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_validate_id_cb

  // ---------- Validate patient_nik
  function do_ajax_form_patient_validate_patient_nik()
  {
    var nomeCampo_patient_nik = "patient_nik";
    var var_patient_nik = scAjaxGetFieldText(nomeCampo_patient_nik);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_validate_patient_nik(var_patient_nik, var_script_case_init, do_ajax_form_patient_validate_patient_nik_cb);
  } // do_ajax_form_patient_validate_patient_nik

  function do_ajax_form_patient_validate_patient_nik_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_validate_patient_nik_cb

  // ---------- Validate name
  function do_ajax_form_patient_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_validate_name(var_name, var_script_case_init, do_ajax_form_patient_validate_name_cb);
  } // do_ajax_form_patient_validate_name

  function do_ajax_form_patient_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_validate_name_cb

  // ---------- Validate no_ihs
  function do_ajax_form_patient_validate_no_ihs()
  {
    var nomeCampo_no_ihs = "no_ihs";
    var var_no_ihs = scAjaxGetFieldText(nomeCampo_no_ihs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_validate_no_ihs(var_no_ihs, var_script_case_init, do_ajax_form_patient_validate_no_ihs_cb);
  } // do_ajax_form_patient_validate_no_ihs

  function do_ajax_form_patient_validate_no_ihs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "no_ihs";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_validate_no_ihs_cb

  // ---------- Validate patient_rm
  function do_ajax_form_patient_validate_patient_rm()
  {
    var nomeCampo_patient_rm = "patient_rm";
    var var_patient_rm = scAjaxGetFieldText(nomeCampo_patient_rm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_validate_patient_rm(var_patient_rm, var_script_case_init, do_ajax_form_patient_validate_patient_rm_cb);
  } // do_ajax_form_patient_validate_patient_rm

  function do_ajax_form_patient_validate_patient_rm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_validate_patient_rm_cb

  // ---------- Validate response
  function do_ajax_form_patient_validate_response()
  {
    var nomeCampo_response = "response";
    var var_response = scAjaxGetFieldText(nomeCampo_response);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_validate_response(var_response, var_script_case_init, do_ajax_form_patient_validate_response_cb);
  } // do_ajax_form_patient_validate_response

  function do_ajax_form_patient_validate_response_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_validate_response_cb

  // ---------- Validate birthdate
  function do_ajax_form_patient_validate_birthdate()
  {
    var nomeCampo_birthdate = "birthdate";
    var var_birthdate = scAjaxGetFieldText(nomeCampo_birthdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_validate_birthdate(var_birthdate, var_script_case_init, do_ajax_form_patient_validate_birthdate_cb);
  } // do_ajax_form_patient_validate_birthdate

  function do_ajax_form_patient_validate_birthdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_validate_birthdate_cb

  // ---------- Validate gender
  function do_ajax_form_patient_validate_gender()
  {
    var nomeCampo_gender = "gender";
    var var_gender = scAjaxGetFieldText(nomeCampo_gender);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_validate_gender(var_gender, var_script_case_init, do_ajax_form_patient_validate_gender_cb);
  } // do_ajax_form_patient_validate_gender

  function do_ajax_form_patient_validate_gender_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gender";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_validate_gender_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_patient_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_patient_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_patient_submit_form(var_id, var_patient_nik, var_name, var_no_ihs, var_patient_rm, var_response, var_birthdate, var_gender, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_patient_submit_form_cb);
  } // do_ajax_form_patient_submit_form

  function do_ajax_form_patient_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_patient_submit_form_cb_after_alert);
  } // do_ajax_form_patient_submit_form_cb
  function do_ajax_form_patient_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_patient_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_patient_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_patient_navigate_form, function() {});
    } else {
      perform_ajax_form_patient_navigate_form();
    }
  }

  function perform_ajax_form_patient_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_patient_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_patient_navigate_form_cb);
  } // do_ajax_form_patient_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_patient']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_patient_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_patient_navigate_form_cb_after_alert);
  } // do_ajax_form_patient_navigate_form_cb
  function do_ajax_form_patient_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_patient_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_patient_navigate_form_cb_after_alert

  function sc_hide_form_patient_form()
  {
