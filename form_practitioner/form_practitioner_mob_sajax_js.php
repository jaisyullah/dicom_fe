  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_practitioner_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_practitioner_mob_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_practitioner_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_practitioner_mob_validate_id(var_id, var_script_case_init, do_ajax_form_practitioner_mob_validate_id_cb);
  } // do_ajax_form_practitioner_mob_validate_id

  function do_ajax_form_practitioner_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_practitioner_mob_validate_id_cb

  // ---------- Validate practitioner_nik
  function do_ajax_form_practitioner_mob_validate_practitioner_nik()
  {
    var nomeCampo_practitioner_nik = "practitioner_nik";
    var var_practitioner_nik = scAjaxGetFieldText(nomeCampo_practitioner_nik);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_practitioner_mob_validate_practitioner_nik(var_practitioner_nik, var_script_case_init, do_ajax_form_practitioner_mob_validate_practitioner_nik_cb);
  } // do_ajax_form_practitioner_mob_validate_practitioner_nik

  function do_ajax_form_practitioner_mob_validate_practitioner_nik_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "practitioner_nik";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_practitioner_mob_validate_practitioner_nik_cb

  // ---------- Validate name
  function do_ajax_form_practitioner_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_practitioner_mob_validate_name(var_name, var_script_case_init, do_ajax_form_practitioner_mob_validate_name_cb);
  } // do_ajax_form_practitioner_mob_validate_name

  function do_ajax_form_practitioner_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_practitioner_mob_validate_name_cb

  // ---------- Validate ihs_no
  function do_ajax_form_practitioner_mob_validate_ihs_no()
  {
    var nomeCampo_ihs_no = "ihs_no";
    var var_ihs_no = scAjaxGetFieldText(nomeCampo_ihs_no);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_practitioner_mob_validate_ihs_no(var_ihs_no, var_script_case_init, do_ajax_form_practitioner_mob_validate_ihs_no_cb);
  } // do_ajax_form_practitioner_mob_validate_ihs_no

  function do_ajax_form_practitioner_mob_validate_ihs_no_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ihs_no";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_practitioner_mob_validate_ihs_no_cb

  // ---------- Validate response
  function do_ajax_form_practitioner_mob_validate_response()
  {
    var nomeCampo_response = "response";
    var var_response = scAjaxGetFieldText(nomeCampo_response);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_practitioner_mob_validate_response(var_response, var_script_case_init, do_ajax_form_practitioner_mob_validate_response_cb);
  } // do_ajax_form_practitioner_mob_validate_response

  function do_ajax_form_practitioner_mob_validate_response_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_practitioner_mob_validate_response_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_practitioner_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_practitioner_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_practitioner_nik = scAjaxGetFieldText("practitioner_nik");
    var var_name = scAjaxGetFieldText("name");
    var var_ihs_no = scAjaxGetFieldText("ihs_no");
    ...
    scAjaxProcOn();
    x_ajax_form_practitioner_mob_submit_form(var_id, var_practitioner_nik, var_name, var_ihs_no, var_response, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_practitioner_mob_submit_form_cb);
  } // do_ajax_form_practitioner_mob_submit_form

  function do_ajax_form_practitioner_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_practitioner_mob_submit_form_cb_after_alert);
  } // do_ajax_form_practitioner_mob_submit_form_cb
  function do_ajax_form_practitioner_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_practitioner_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_practitioner_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_practitioner_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_practitioner_mob_navigate_form();
    }
  }

  function perform_ajax_form_practitioner_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_practitioner_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_practitioner_mob_navigate_form_cb);
  } // do_ajax_form_practitioner_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_practitioner_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_practitioner_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_practitioner_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_practitioner_mob_navigate_form_cb
  function do_ajax_form_practitioner_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_practitioner_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_practitioner_mob_navigate_form_cb_after_alert

  function sc_hide_form_practitioner_mob_form()
  {
  ...
  ajax_field_list[1] = "practitioner_nik";
  ajax_field_list[2] = "name";
  ajax_field_list[3] = "ihs_no";
  ajax_field_list[4] = "response";
  ...
  var ajax_error_list = {
    ...
    "practitioner_nik": {"label": "Practitioner Nik", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "name": {"label": "Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ihs_no": {"label": "Ihs No", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
  ...
  var ajax_field_mult = {
    "id": new Array(),
    "practitioner_nik": new Array(),
    "name": new Array(),
    "ihs_no": new Array(),
    "response": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["practitioner_nik"][1] = "practitioner_nik";
  ajax_field_mult["name"][1] = "name";
  ajax_field_mult["ihs_no"][1] = "ihs_no";
  ajax_field_mult["response"][1] = "response";

  var ajax_field_id = {
    "practitioner_nik": new Array("hidden_field_label_practitioner_nik", "hidden_field_data_practitioner_nik"),
    "name": new Array("hidden_field_label_name", "hidden_field_data_name"),
    "ihs_no": new Array("hidden_field_label_ihs_no", "hidden_field_data_ihs_no"),
    "response": new Array("hidden_field_label_response", "hidden_field_data_response")
  };

  var ajax_read_only = {
    "id": "on",
    "practitioner_nik": "off",
    "name": "off",
    "ihs_no": "off",
    "response": "off"
  };
