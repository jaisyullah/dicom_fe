  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_practitioner" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_practitioner_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_practitioner_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_practitioner_validate_id(var_id, var_script_case_init, do_ajax_form_practitioner_validate_id_cb);
  } // do_ajax_form_practitioner_validate_id

  function do_ajax_form_practitioner_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_practitioner_validate_id_cb

  // ---------- Validate practitioner_nik
  function do_ajax_form_practitioner_validate_practitioner_nik()
  {
    var nomeCampo_practitioner_nik = "practitioner_nik";
    var var_practitioner_nik = scAjaxGetFieldText(nomeCampo_practitioner_nik);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_practitioner_validate_practitioner_nik(var_practitioner_nik, var_script_case_init, do_ajax_form_practitioner_validate_practitioner_nik_cb);
  } // do_ajax_form_practitioner_validate_practitioner_nik

  function do_ajax_form_practitioner_validate_practitioner_nik_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_practitioner_validate_practitioner_nik_cb

  // ---------- Validate name
  function do_ajax_form_practitioner_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_practitioner_validate_name(var_name, var_script_case_init, do_ajax_form_practitioner_validate_name_cb);
  } // do_ajax_form_practitioner_validate_name

  function do_ajax_form_practitioner_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_practitioner_validate_name_cb

  // ---------- Validate ihs_no
  function do_ajax_form_practitioner_validate_ihs_no()
  {
    var nomeCampo_ihs_no = "ihs_no";
    var var_ihs_no = scAjaxGetFieldText(nomeCampo_ihs_no);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_practitioner_validate_ihs_no(var_ihs_no, var_script_case_init, do_ajax_form_practitioner_validate_ihs_no_cb);
  } // do_ajax_form_practitioner_validate_ihs_no

  function do_ajax_form_practitioner_validate_ihs_no_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ihs_no";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_practitioner_validate_ihs_no_cb

  // ---------- Validate response
  function do_ajax_form_practitioner_validate_response()
  {
    var nomeCampo_response = "response";
    var var_response = scAjaxGetFieldText(nomeCampo_response);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_practitioner_validate_response(var_response, var_script_case_init, do_ajax_form_practitioner_validate_response_cb);
  } // do_ajax_form_practitioner_validate_response

  function do_ajax_form_practitioner_validate_response_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_practitioner_validate_response_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_practitioner_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_practitioner_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_practitioner_submit_form(var_id, var_practitioner_nik, var_name, var_ihs_no, var_response, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_practitioner_submit_form_cb);
  } // do_ajax_form_practitioner_submit_form

  function do_ajax_form_practitioner_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_practitioner_submit_form_cb_after_alert);
  } // do_ajax_form_practitioner_submit_form_cb
  function do_ajax_form_practitioner_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_practitioner_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_practitioner_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_practitioner_navigate_form, function() {});
    } else {
      perform_ajax_form_practitioner_navigate_form();
    }
  }

  function perform_ajax_form_practitioner_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_practitioner_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_practitioner_navigate_form_cb);
  } // do_ajax_form_practitioner_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_practitioner']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_practitioner_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_practitioner_navigate_form_cb_after_alert);
  } // do_ajax_form_practitioner_navigate_form_cb
  function do_ajax_form_practitioner_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_practitioner_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_practitioner_navigate_form_cb_after_alert

  function sc_hide_form_practitioner_form()
  {
