<?php
@session_start() ;
$_SESSION['scriptcase']['grid_credential']['sc_process_barr'] = true;
require_once('../grid_credential/index.php');
unset($_SESSION['scriptcase']['grid_credential']['sc_process_barr']);
$ExportCtrl = new grid_credential_export_control;
$ExportCtrl->Export_barr();

class grid_credential_export_control
{
