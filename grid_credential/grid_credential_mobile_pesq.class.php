...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id";$Nm_numeric[] = "organization_id";$Nm_numeric[] = "id";$Nm_numeric[] = "organization_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_organization_id_cond" name="organization_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_organization_id'), this, 'organization_id')">
      ...
      <br><span id="id_hide_organization_id"  <?php echo $str_hide_organization_id?>><INPUT  type="text" id="SC_organization_id" name="organization_id" value="<?php echo NM_encode_input($organization_id) ?>" size=25 alt="{datatype: 'integer', maxLength: 25, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_id"  <?php echo $str_hide_id?>><INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=1 alt="{datatype: 'integer', maxLength: 1, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_client_secret_cond" name="client_secret_cond" onChange="nm_campos_between(document.getElementById('id_vis_client_secret'), this, 'client_secret')">
