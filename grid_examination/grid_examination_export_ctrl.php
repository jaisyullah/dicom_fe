<?php
@session_start() ;
$_SESSION['scriptcase']['grid_examination']['sc_process_barr'] = true;
require_once('../grid_examination/index.php');
unset($_SESSION['scriptcase']['grid_examination']['sc_process_barr']);
$ExportCtrl = new grid_examination_export_control;
$ExportCtrl->Export_barr();

class grid_examination_export_control
{
