<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_examination']['glo_nm_path_imag_temp'] . "/sc_apl_default_dicom_fe.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_examination_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_examination_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["id"] : "ID";
   $tab_ger_campos['patient_rm'] = "on";
   $tab_def_campos['patient_rm'] = "patient_rm";
   $tab_labels["patient_rm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["patient_rm"])) ? $_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["patient_rm"] : "RM Pasien";
   $tab_ger_campos['jenis_pemeriksaan'] = "on";
   $tab_def_campos['jenis_pemeriksaan'] = "jenis_pemeriksaan";
   $tab_labels["jenis_pemeriksaan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["jenis_pemeriksaan"])) ? $_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["jenis_pemeriksaan"] : "Jenis Pemeriksaan";
   $tab_ger_campos['tgl_pemeriksaan'] = "on";
   $tab_def_campos['tgl_pemeriksaan'] = "tgl_pemeriksaan";
   $tab_labels["tgl_pemeriksaan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["tgl_pemeriksaan"])) ? $_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["tgl_pemeriksaan"] : "Tgl Pemeriksaan";
   $tab_ger_campos['dpjp'] = "on";
   $tab_def_campos['dpjp'] = "dpjp";
   $tab_labels["dpjp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["dpjp"])) ? $_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["dpjp"] : "DPJP";
   $tab_ger_campos['accno'] = "on";
   $tab_def_campos['accno'] = "AccNo";
   $tab_labels["accno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["accno"])) ? $_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["accno"] : "Accession Number";
   $tab_ger_campos['identifiersr'] = "on";
   $tab_def_campos['identifiersr'] = "identifierSR";
   $tab_labels["identifiersr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["identifiersr"])) ? $_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["identifiersr"] : "Identifier Service-Req";
   $tab_ger_campos['mwl'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['mwl'] = "MWL";
   }
   else
   {
       $tab_def_campos['mwl'] = "";
   }
   $tab_labels["mwl"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["mwl"])) ? $_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["mwl"] : "MWL";
   $tab_ger_campos['satusehat'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['satusehat'] = "SATUSEHAT";
   }
   else
   {
       $tab_def_campos['satusehat'] = "";
   }
   $tab_labels["satusehat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["satusehat"])) ? $_SESSION['sc_session'][$sc_init]['grid_examination']['labels']["satusehat"] : "SATUSEHAT";
   $tab_ger_campos['mwl'] = "none";
   $tab_ger_campos['satusehat'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_examination']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_examination']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_examination']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> examination</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_examination_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_examination']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
