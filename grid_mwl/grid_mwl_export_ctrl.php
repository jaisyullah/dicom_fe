<?php
@session_start() ;
$_SESSION['scriptcase']['grid_mwl']['sc_process_barr'] = true;
require_once('../grid_mwl/index.php');
unset($_SESSION['scriptcase']['grid_mwl']['sc_process_barr']);
$ExportCtrl = new grid_mwl_export_control;
$ExportCtrl->Export_barr();

class grid_mwl_export_control
{
