...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_mwl_ip_cond" name="mwl_ip_cond" onChange="nm_campos_between(document.getElementById('id_vis_mwl_ip'), this, 'mwl_ip')">
      ...
      <br><span id="id_hide_mwl_ip"  <?php echo $str_hide_mwl_ip?>><INPUT  type="text" id="SC_mwl_ip" name="mwl_ip" value="<?php echo NM_encode_input($mwl_ip) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_mwl_port_cond" name="mwl_port_cond" onChange="nm_campos_between(document.getElementById('id_vis_mwl_port'), this, 'mwl_port')">
      ...
      <br><span id="id_hide_mwl_port"  <?php echo $str_hide_mwl_port?>><INPUT  type="text" id="SC_mwl_port" name="mwl_port" value="<?php echo NM_encode_input($mwl_port) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
