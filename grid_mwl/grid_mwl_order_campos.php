...
<?php
   ...
   $Ord_Cmp = new grid_mwl_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_mwl_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['mwl_ip'] = "mwl_ip";
   $tab_labels["mwl_ip"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mwl']['labels']["mwl_ip"])) ? $_SESSION['sc_session'][$sc_init]['grid_mwl']['labels']["mwl_ip"] : "MWL IP";
   $tab_ger_campos['mwl_port'] = "on";
   $tab_def_campos['mwl_port'] = "mwl_port";
   $tab_labels["mwl_port"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mwl']['labels']["mwl_port"])) ? $_SESSION['sc_session'][$sc_init]['grid_mwl']['labels']["mwl_port"] : "MWL Port";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_mwl']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_mwl']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_mwl']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_mwl']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
