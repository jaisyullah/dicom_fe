<?php
@session_start() ;
$_SESSION['scriptcase']['grid_patient']['sc_process_barr'] = true;
require_once('../grid_patient/index.php');
unset($_SESSION['scriptcase']['grid_patient']['sc_process_barr']);
$ExportCtrl = new grid_patient_export_control;
$ExportCtrl->Export_barr();

class grid_patient_export_control
{
