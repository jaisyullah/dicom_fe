...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dicom_fe_____grid_patient"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dicom_fe_____grid_patient"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_patient'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_patient']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_patient']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_patient']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_patient']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_patient']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_patient']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_patient']['embutida_filho'] as $ind => $sc_init)
          {
