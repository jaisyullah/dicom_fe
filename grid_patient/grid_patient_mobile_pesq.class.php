...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_no_ihs_cond" name="no_ihs_cond" onChange="nm_campos_between(document.getElementById('id_vis_no_ihs'), this, 'no_ihs')">
      ...
      <br><span id="id_hide_no_ihs"  <?php echo $str_hide_no_ihs?>><INPUT  type="text" id="SC_no_ihs" name="no_ihs" value="<?php echo NM_encode_input($no_ihs) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_patient_nik_cond" name="patient_nik_cond" onChange="nm_campos_between(document.getElementById('id_vis_patient_nik'), this, 'patient_nik')">
      ...
      <br><span id="id_hide_patient_nik"  <?php echo $str_hide_patient_nik?>><INPUT  type="text" id="SC_patient_nik" name="patient_nik" value="<?php echo NM_encode_input($patient_nik) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
