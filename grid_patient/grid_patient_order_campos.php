...
<?php
   ...
   $Ord_Cmp = new grid_patient_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_patient_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['patient_nik'] = "patient_nik";
   $tab_labels["patient_nik"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patient']['labels']["patient_nik"])) ? $_SESSION['sc_session'][$sc_init]['grid_patient']['labels']["patient_nik"] : "Patient NIK";
   $tab_ger_campos['name'] = "on";
   $tab_def_campos['name'] = "name";
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patient']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_patient']['labels']["name"] : "Name";
   $tab_ger_campos['no_ihs'] = "on";
   $tab_def_campos['no_ihs'] = "no_ihs";
   $tab_labels["no_ihs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patient']['labels']["no_ihs"])) ? $_SESSION['sc_session'][$sc_init]['grid_patient']['labels']["no_ihs"] : "No IHS";
   $tab_ger_campos['patient_rm'] = "on";
   $tab_def_campos['patient_rm'] = "patient_rm";
   $tab_labels["patient_rm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patient']['labels']["patient_rm"])) ? $_SESSION['sc_session'][$sc_init]['grid_patient']['labels']["patient_rm"] : "Patient RM";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_patient']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_patient']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_patient']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_patient_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_patient']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
