<?php
@session_start() ;
$_SESSION['scriptcase']['grid_practitioner']['sc_process_barr'] = true;
require_once('../grid_practitioner/index.php');
unset($_SESSION['scriptcase']['grid_practitioner']['sc_process_barr']);
$ExportCtrl = new grid_practitioner_export_control;
$ExportCtrl->Export_barr();

class grid_practitioner_export_control
{
