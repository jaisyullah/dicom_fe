...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["dicom_fe_____grid_practitioner"]))
   {
      unset($_SESSION['session_sec_aplicacao']["dicom_fe_____grid_practitioner"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_practitioner'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_practitioner']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_practitioner']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_practitioner']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_practitioner']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_practitioner']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_practitioner']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_practitioner']['embutida_filho'] as $ind => $sc_init)
          {
