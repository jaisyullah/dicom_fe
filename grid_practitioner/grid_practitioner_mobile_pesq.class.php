...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ihs_no_cond" name="ihs_no_cond" onChange="nm_campos_between(document.getElementById('id_vis_ihs_no'), this, 'ihs_no')">
      ...
      <br><span id="id_hide_ihs_no"  <?php echo $str_hide_ihs_no?>><INPUT  type="text" id="SC_ihs_no" name="ihs_no" value="<?php echo NM_encode_input($ihs_no) ?>"  size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_practitioner_nik_cond" name="practitioner_nik_cond" onChange="nm_campos_between(document.getElementById('id_vis_practitioner_nik'), this, 'practitioner_nik')">
      ...
      <br><span id="id_hide_practitioner_nik"  <?php echo $str_hide_practitioner_nik?>><INPUT  type="text" id="SC_practitioner_nik" name="practitioner_nik" value="<?php echo NM_encode_input($practitioner_nik) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_name"  <?php echo $str_hide_name?>><INPUT  type="text" id="SC_name" name="name" value="<?php echo NM_encode_input($name) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
