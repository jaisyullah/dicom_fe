...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['index']['glo_nm_perfil']         = "conn_sqlite";
    $_SESSION['scriptcase']['index']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['index']['glo_nm_usa_grupo']      = "";
...
class index_class
{
 ...
 function index_menu()
 {
    global $index_menuData, $nm_data_fixa;
...
$path_libs      = $str_root . $_SESSION['scriptcase']['index']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['index']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['index']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "index/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['index']['glo_nm_path_imag_temp'];
...
include_once(dirname(__FILE__) . "/index_erro.class.php"); 
$this->Erro = new index_erro();
$str_path = substr($_SESSION['scriptcase']['index']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['index']['glo_nm_path_prod'], '/') + 1);
...
/* Path definitions */
$index_menuData         = array();
$index_menuData['path'] = array();
$index_menuData['url']  = array();
$index_menuData['data'] = "";
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $index_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $index_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $index_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $index_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$index_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$index_menuData['url']['web']   = str_replace("\\", '/', $index_menuData['url']['web']);
$index_menuData['path']['root'] = substr($index_menuData['path']['sys'],  0, -1 * strlen($index_menuData['url']['web']));
$index_menuData['path']['app']  = substr($index_menuData['path']['sys'],  0, strrpos($index_menuData['path']['sys'],  '/'));
$index_menuData['path']['link'] = substr($index_menuData['path']['app'],  0, strrpos($index_menuData['path']['app'],  '/'));
$index_menuData['path']['link'] = substr($index_menuData['path']['link'], 0, strrpos($index_menuData['path']['link'], '/')) . '/';
$index_menuData['path']['app'] .= '/';
$index_menuData['url']['app']   = substr($index_menuData['url']['web'],  0, strrpos($index_menuData['url']['web'],  '/'));
$index_menuData['url']['link']  = substr($index_menuData['url']['app'],  0, strrpos($index_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] == "S")
{
    $index_menuData['url']['link']  = substr($index_menuData['url']['link'], 0, strrpos($index_menuData['url']['link'], '/'));
}
$index_menuData['url']['link']  .= '/';
$index_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['index']['sc_apl_link'] = $index_menuData['url']['link'];
...
include_once("index_toolbar.php");

$this->tab_grupo[0] = "dicom_fe/";
if ($_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
}

     $_SESSION['scriptcase']['menu_atual'] = "index";
     $_SESSION['scriptcase']['menu_apls']['index'] = array();
...
{
    $_SESSION['sc_session'][1]['index']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['index']['init']))
{
    $_SESSION['sc_session'][1]['index']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['index']['init'];
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_index'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_index'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_index'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['index']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['index']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'index'))
{
    $_SESSION['sc_session'][1]['index']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_index'] = "javascript:window.close()";
}
/* Menu configuration variables */
$index_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_patient") . "/grid_patient_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_patient") . "/grid_patient_ini.txt");
    ...
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_patient']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_patient'] = "on";
        }
    }
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_practitioner") . "/grid_practitioner_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_practitioner") . "/grid_practitioner_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_practitioner']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_practitioner'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_examination") . "/grid_examination_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_examination") . "/grid_examination_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_examination']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_examination'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_credential") . "/grid_credential_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_credential") . "/grid_credential_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_credential']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_credential'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_mwl") . "/grid_mwl_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_mwl") . "/grid_mwl_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_mwl']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_mwl'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
$_SESSION['scriptcase']['index']['contr_erro'] = 'on';
 ?>
<style>
	#idMenuLine, ul#css3menu1 li.topmenu>a {
	...
	.menu__link {
		font-family: Leelawadee, Ebrima, 'Bahnschrift Light', Gadugi, 'Nirmala UI', 'Segoe UI', Verdana !important;
	}
	
	.menu__link > .fa, .fab, .fal, .far, .fas {
		padding-right: 5px;		
	}
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[2]))
{
 ...
 $nm_var_lab[3] = "Entri Permintaan USG";
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_index'];
$index_menuData['data'] .= "item_43|.|" . $nm_var_lab[0] . "||" . $nm_var_hint[0] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_patient']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_patient']) == "on")
{
    $index_menuData['data'] .= "item_12|..|" . $nm_var_lab[1] . "|index_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_patient&sc_apl_link=" . urlencode($index_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "|scriptcase__NM__ico__NM__sc_menu_menutree_e.png|" . $this->index_target('_self') . "|" . "\n";
}
else
{
    $index_menuData['data'] .= "item_12|..|" . $nm_var_lab[1] . "|||scriptcase__NM__ico__NM__sc_menu_menutree_e.png|_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_practitioner']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_practitioner']) == "on")
{
    $index_menuData['data'] .= "item_30|..|" . $nm_var_lab[2] . "|index_form_php.php?sc_item_menu=item_30&sc_apl_menu=grid_practitioner&sc_apl_link=" . urlencode($index_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->index_target('_self') . "|" . "\n";
}
else
{
    $index_menuData['data'] .= "item_30|..|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_examination']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_examination']) == "on")
{
    $index_menuData['data'] .= "item_31|.|" . $nm_var_lab[3] . "|index_form_php.php?sc_item_menu=item_31&sc_apl_menu=grid_examination&sc_apl_link=" . urlencode($index_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->index_target('_self') . "|" . "\n";
}
else
{
    $index_menuData['data'] .= "item_31|.|" . $nm_var_lab[3] . "||||_self|disabled\n";
}
$index_menuData['data'] .= "item_45|.|" . $nm_var_lab[4] . "||" . $nm_var_hint[4] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_credential']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_credential']) == "on")
{
    $index_menuData['data'] .= "item_32|..|" . $nm_var_lab[5] . "|index_form_php.php?sc_item_menu=item_32&sc_apl_menu=grid_credential&sc_apl_link=" . urlencode($index_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->index_target('_self') . "|" . "\n";
}
else
{
    $index_menuData['data'] .= "item_32|..|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_mwl']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_mwl']) == "on")
{
    $index_menuData['data'] .= "item_44|..|" . $nm_var_lab[6] . "|index_form_php.php?sc_item_menu=item_44&sc_apl_menu=grid_mwl&sc_apl_link=" . urlencode($index_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->index_target('_self') . "|" . "\n";
}
else
{
    $index_menuData['data'] .= "item_44|..|" . $nm_var_lab[6] . "||||_self|disabled\n";
}
...
$str_disabled = "N";
$str_link = "index_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_patient&sc_apl_link=" . urlencode($index_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_patient']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_patient']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    $str_icon = "scriptcase__NM__ico__NM__sc_menu_menutree_e.png";
    $icon_aba = "";
    $icon_aba_inactive = "";
    ...
    $index_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->index_target('_self') . "\"",
        'sc_id'    => "item_12",
        'disabled' => $str_disabled,
        'display'     => "text_fontawesomeicon",
        'display_position'=> "text_right",
        ...
        'icon_color_disabled'     => "#dcdcdc",
    );
$str_disabled = "N";
$str_link = "index_form_php.php?sc_item_menu=item_30&sc_apl_menu=grid_practitioner&sc_apl_link=" . urlencode($index_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_practitioner']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_practitioner']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $index_menuData['data'][] = array(
        ...
        'display'     => "text_fontawesomeicon",
        'display_position'=> "text_right",
        'icon_fa'     => "fas fa-grip-horizontal",
        'icon_color'     => "#ffffff",
        'icon_color_hover'     => "#ffffff",
        'icon_color_disabled'     => "#dcdcdc",
    );
$str_disabled = "N";
$str_link = "index_form_php.php?sc_item_menu=item_31&sc_apl_menu=grid_examination&sc_apl_link=" . urlencode($index_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_examination']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_examination']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "index_form_php.php?sc_item_menu=item_32&sc_apl_menu=grid_credential&sc_apl_link=" . urlencode($index_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_credential']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_credential']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "index_form_php.php?sc_item_menu=item_44&sc_apl_menu=grid_mwl&sc_apl_link=" . urlencode($index_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_mwl']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_mwl']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['index']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['index']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'index');
    $index_menuData['data'] = $str_menu_usu;
}
if (is_file("index_help.txt"))
{
    $Arq_WebHelp = file("index_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $index_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->index_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['index']) && !empty($_SESSION['scriptcase']['sc_menu_del']['index']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($index_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['index']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($index_menuData['data'][$i_menu]);
       }
    ...
    $index_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['index']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['index']))
{
    $disable_menu = false;
    foreach ($index_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['index']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $index_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* HTML header */
if ($index_menuData['iframe'])
{
    $index_menuData['height'] = '100%';
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['index']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
<style>
   .scTabText {
   }   #item_12 .icon_fa{ color: #ffffff  !important}
   #item_12:hover .icon_fa{ color: #ffffff  !important}
   #item_12.scdisabledmain .icon_fa{ color: #dcdcdc  !important}
   #item_12.scdisabledsub .icon_fa{ color: #dcdcdc  !important}
   #item_30 .icon_fa{ color: #ffffff  !important}
   #item_30:hover .icon_fa{ color: #ffffff  !important}
   #item_30.scdisabledmain .icon_fa{ color: #dcdcdc  !important}
   #item_30.scdisabledsub .icon_fa{ color: #dcdcdc  !important}
   #item_31 .icon_fa{ color: #ffffff  !important}
   #item_31:hover .icon_fa{ color: #ffffff  !important}
   #item_31.scdisabledmain .icon_fa{ color: #dcdcdc  !important}
   #item_31.scdisabledsub .icon_fa{ color: #dcdcdc  !important}
   #item_32 .icon_fa{ color: #ffffff  !important}
   #item_32:hover .icon_fa{ color: #ffffff  !important}
   #item_32.scdisabledmain .icon_fa{ color: #dcdcdc  !important}
   #item_32.scdisabledsub .icon_fa{ color: #dcdcdc  !important}
    <?php
...
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['index']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['index']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['index']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['index']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="index_message.js"></script>
...
<?php
 $seq = 0;
 if(isset($index_menuData['data']) && !empty($index_menuData['data']))
 {
   foreach ($index_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($index_menuData['data_vertical']) && !empty($index_menuData['data_vertical']))
 {
   foreach ($index_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'index_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'index'){ home_style=";padding-left:4px;min-height:14px;"; }
...
function mudaIframe(str_id)
{
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="index_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            Iframe_atual = "index_" + Tab_iframes[i] + '_iframe';
...
{
  str_target_sv = "";
  if (str_id != "iframe_index")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("index_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    if (str_target == "index_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        ...
        if (str_id != "index" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_index').length)
        $('#iframe_index')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<div class="scMenuHHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scMenuHHeaderFont" style="float: left; text-transform: uppercase;"><?php echo "Service Request Generator :: SATUSEHAT" ?></div>
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $index_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->index_escreveMenu($index_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
       </td></tr></table>
<?php
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $index_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
...
?>
    <div id="Iframe_control" style='width:100%; height:100%; margin:0px; padding:0px;'>
      <iframe id="iframe_index" name="index_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "index_pag_ini.php"); ?>"></iframe>
<?php
}
?></div></td>
  </tr>
...
/* Target control */
function index_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function index_target($str_target)
{
    global $index_menuData;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $index_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "index_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($index_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "index_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($index_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['index']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->index_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['index']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['index']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['index']['sc_init'][$apl_menu];
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['index']['glo_nm_path_imag_temp'] . "/sc_apl_default_dicom_fe.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['index']['glo_nm_path_imag_temp'] . "/sc_apl_default_dicom_fe.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "index") {
        ...
        if (isset($_COOKIE['sc_actual_lang_dicom_fe'])) {
            $_SESSION['scriptcase']['index']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_dicom_fe'];
        }
    }
}
...
$contr_index = new index_class;
$contr_index->index_menu();
