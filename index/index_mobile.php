...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["index"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["index"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["index"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($index_menuData["data"]) && is_array($index_menuData["data"]) && !empty($index_menuData["data"]))
    {
        foreach($index_menuData["data"] as $arr_item)
        {
...
?>
    ...
    <?php
        escreveMenuMobile($index_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
